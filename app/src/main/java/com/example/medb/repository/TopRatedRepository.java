...
public class TopRatedRepository {
    ...
    public TopRatedRepository(Application application) {
    ...
    public MutableLiveData<List<Movie>> getMutableLiveData(){
        ...
        Call<Result> call = movieDataService.getTopRatedMovies(application.getApplicationContext().getString(R.string.api_key));
